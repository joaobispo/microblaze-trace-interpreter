...
/**
 *  Implements the MicroBlaze Branch Immediate if Not Equal.
 * 
 * <p> Includes the instructions bnei and bneid.
 *
 * @author Joao Bispo
 */
public class MbBnei implements Instruction, Builder {
    ...
    public Instruction build(TraceData data, MicroBlazeProcessor processor) {
        return new MbBnei(data, processor);
    }
     ...
     */
    public MbBnei(TraceData data, MicroBlazeProcessor processor) {
