...
/**
 *  Implements the MicroBlaze Store Halfword Immediate.
 * 
 * <p> Includes the instruction shi.
 *
 * @author Joao Bispo
 */
public class MbShi implements Instruction, Builder {
    ...
    public Instruction build(TraceData data, MicroBlazeProcessor processor) {
        return new MbShi(data, processor);
    }
     ...
     */
    public MbShi(TraceData data, MicroBlazeProcessor processor) {
    ...
    public void execute() {
        ...
        if(bit0 == 0) {
            memory.storeHalfword(halfwordAddress, rD);
             ...
             System.out.println("shi: address is not halfword aligned ("+
