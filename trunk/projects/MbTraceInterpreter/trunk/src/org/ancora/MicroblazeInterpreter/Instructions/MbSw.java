...
/**
 *  Implements the MicroBlaze Store Word.
 * 
 * <p> Includes the instruction sw.
 *
 * @author Joao Bispo
 */
public class MbSw implements Instruction, Builder {
    ...
    public Instruction build(TraceData data, MicroBlazeProcessor processor) {
        return new MbSw(data, processor);
    }
     ...
     */
    public MbSw(TraceData data, MicroBlazeProcessor processor) {
    ...
    public void execute() {
        ...
        if(bit0 == 0 & bit1 == 0) {
            memory.storeHalfword(wordAddress, rD);
             ...
             System.out.println("sw: address is not word aligned ("+
