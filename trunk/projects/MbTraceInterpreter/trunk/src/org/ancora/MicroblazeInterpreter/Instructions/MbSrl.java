...
/**
 *  Implements the MicroBlaze Shift Right Logical.
 * 
 * <p> Includes the instruction srl.
 *
 * @author Joao Bispo
 */
public class MbSrl implements Instruction, Builder {
    ...
    public Instruction build(TraceData data, MicroBlazeProcessor processor) {
        return new MbSrl(data, processor);
    }
     ...
     */
    public MbSrl(TraceData data, MicroBlazeProcessor processor) {
