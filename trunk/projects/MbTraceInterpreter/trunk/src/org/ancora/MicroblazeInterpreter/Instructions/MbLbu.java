...
/**
 *  Implements the MicroBlaze Load Byte Unsigned.
 * 
 * <p> Includes the instruction lbu .
 *
 * @author Joao Bispo
 */
public class MbLbu implements Instruction, Builder {
    ...
    public Instruction build(TraceData data, MicroBlazeProcessor processor) {
        return new MbLbu(data, processor);
    }
     ...
     */
    public MbLbu(TraceData data, MicroBlazeProcessor processor) {
