...
/**
 *  Implements the MicroBlaze Logical Exclusive OR with Immediate.
 * 
 * <p> Includes the instruction xori.
 *
 * @author Joao Bispo
 */
public class MbXori implements Instruction, Builder {
    ...
    public Instruction build(TraceData data, MicroBlazeProcessor processor) {
        return new MbXori(data, processor);
    }
     ...
     */
    public MbXori(TraceData data, MicroBlazeProcessor processor) {
    ...
    public void execute() {
        ...
        // Check if imm was exteded or concatenated. 
        // If extended, clear upper half.
        if(!lockReg.isLocked()) {
