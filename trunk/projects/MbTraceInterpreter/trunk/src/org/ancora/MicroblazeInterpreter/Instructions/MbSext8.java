...
/**
 *  Implements the MicroBlaze Sign Extend Byte.
 * 
 * <p> Includes the instruction sext8.
 *
 * @author Joao Bispo
 */
public class MbSext8 implements Instruction, Builder {
    ...
    public Instruction build(TraceData data, MicroBlazeProcessor processor) {
        return new MbSext8(data, processor);
    }
     ...
     */
    public MbSext8(TraceData data, MicroBlazeProcessor processor) {
