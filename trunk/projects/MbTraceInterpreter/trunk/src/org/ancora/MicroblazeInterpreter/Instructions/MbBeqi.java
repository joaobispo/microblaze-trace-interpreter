...
/**
 *  Implements the MicroBlaze Branch Immediate if Equal.
 * 
 * <p> Includes the instructions beqi and beqid.
 *
 * @author Joao Bispo
 */
public class MbBeqi implements Instruction, Builder {
    ...
    public Instruction build(TraceData data, MicroBlazeProcessor processor) {
        return new MbBeqi(data, processor);
    }
     ...
     */
    public MbBeqi(TraceData data, MicroBlazeProcessor processor) {
