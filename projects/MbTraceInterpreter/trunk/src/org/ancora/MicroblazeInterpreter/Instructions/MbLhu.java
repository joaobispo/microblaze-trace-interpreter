...
/**
 *  Implements the MicroBlaze Load Halfword Unsigned.
 * 
 * <p> Includes the instruction lhu .
 *
 * @author Joao Bispo
 */
public class MbLhu implements Instruction, Builder {
    ...
    public Instruction build(TraceData data, MicroBlazeProcessor processor) {
        return new MbLhu(data, processor);
    }
     ...
     */
    public MbLhu(TraceData data, MicroBlazeProcessor processor) {
    ...
    public void execute() {
        ...
        if(bit0 == 0) {
            ...
            System.out.println("lhu: address is not halfword aligned ("+
