...
/**
 *  Implements the MicroBlaze Branch Immediate if Greater Than.
 * 
 * <p> Includes the instructions bgti and bgtid.
 *
 * @author Joao Bispo
 */
public class MbBgti implements Instruction, Builder {
    ...
    public Instruction build(TraceData data, MicroBlazeProcessor processor) {
        return new MbBgti(data, processor);
    }
     ...
     */
    public MbBgti(TraceData data, MicroBlazeProcessor processor) {
