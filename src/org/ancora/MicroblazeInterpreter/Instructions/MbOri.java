...
/**
 *  Implements the MicroBlaze Logical OR with Immediate.
 * 
 * <p> Includes the instruction ori.
 *
 * @author Joao Bispo
 */
public class MbOri implements Instruction, Builder {
    ...
    public Instruction build(TraceData data, MicroBlazeProcessor processor) {
        return new MbOri(data, processor);
    }
     ...
     */
    public MbOri(TraceData data, MicroBlazeProcessor processor) {
