...
/**
 *  Implements the MicroBlaze Store Byte Immediate.
 * 
 * <p> Includes the instruction sbi.
 *
 * @author Joao Bispo
 */
public class MbSbi implements Instruction, Builder {
    ...
    public Instruction build(TraceData data, MicroBlazeProcessor processor) {
        return new MbSbi(data, processor);
    }
     ...
     */
    public MbSbi(TraceData data, MicroBlazeProcessor processor) {
