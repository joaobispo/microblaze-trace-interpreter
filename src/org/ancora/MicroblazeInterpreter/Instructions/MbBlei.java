...
/**
 *  Implements the MicroBlaze Branch Immediate if Less or Equal.
 * 
 * <p> Includes the instructions blei and bleid.
 *
 * @author Joao Bispo
 */
public class MbBlei implements Instruction, Builder {
    ...
    public Instruction build(TraceData data, MicroBlazeProcessor processor) {
        return new MbBlei(data, processor);
    }
     ...
     */
    public MbBlei(TraceData data, MicroBlazeProcessor processor) {
